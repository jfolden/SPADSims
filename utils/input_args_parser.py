...
def add_flash_lidar_scene_args( parser ):
	...
	parser.add_argument('-max_transient_path_len', type=float, default = 10, help='Max path length simulated in the transient in meters. This means that the last element in the transient corresponds to a signal that traveled this distance. The max depth will be 0.5 of this value')
